...
class main:
	...
	def pft():
		...
		if get_Gender == "Male" and get_event2 == "Crunches":
		...
		elif get_Gender == "Female" and get_event2 == "Crunches":
		...
		if get_Altitude == "No":
			if get_Gender == "Male" and get_event3 == "Run":
				...
				event3 = run_pts
			elif get_Gender == "Male" and get_event3 == "Row":
				...
				event3 = row_pts
			elif get_Gender == "Female" and get_event3 == "Run":
				...
				event3 = run_pts
			elif get_Gender == "Female" and get_event3 == "Row":
		...
		pft = int(event1) + int(event2) + int(event3)
